...
class Test_MainBinomial:
    ...
    def test_binomial_invalid_input(self):
        ...
        with pytest.raises(ValueError):
            result = binomial(num)
            assert result, "Test failed: Function should have raised ValueError for num[0] less than num[1]"
    ...
    def test_binomial_negative_input(self):
        ...
        with pytest.raises(ValueError):
            result = binomial(num)
            assert result, "Test failed: Function should have raised ValueError for negative integers"
