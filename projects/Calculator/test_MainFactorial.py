...
class Test_MainFactorial:
    ...
    def test_factorial_positive_integer(self):
        assert factorial(5) == 120, "Test failed: Factorial of 5 should be 120."

    def test_factorial_zero(self):
        assert factorial(0) == 1, "Test failed: Factorial of 0 should be 1."

    def test_factorial_negative_integer(self):
        assert factorial(-5) == 1, "Test failed: Factorial of a negative number should return 1."

    def test_factorial_large_integer(self):
        assert factorial(20) == 2432902008176640000, "Test failed: Factorial of 20 should be 2432902008176640000."
