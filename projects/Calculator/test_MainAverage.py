...
class Test_MainAverage:
    ...
    def test_average_with_large_numbers(self, monkeypatch):
        input_string = "1000000 2000000 3000000"
        monkeypatch.setattr('builtins.input', lambda _: input_string)
        result = average()
    ...
    @pytest.mark.negative
    def test_average_with_non_numeric_values(self, monkeypatch):
        input_string = "10 20 abc 30"
        monkeypatch.setattr('builtins.input', lambda _: input_string)
        with pytest.raises(ValueError):
            average()
    ...
    def test_average_with_floating_point_numbers(self, monkeypatch):
        input_string = "10.5 20.5 30.5"
        monkeypatch.setattr('builtins.input', lambda _: input_string)
        result = average()
        assert result == 20.5, f"Expected 20.5 but got {result}"

    @pytest.mark.positive
    def test_average_with_identical_numbers(self, monkeypatch):
        input_string = "5 5 5 5 5"
        monkeypatch.setattr('builtins.input', lambda _: input_string)
        result = average()
