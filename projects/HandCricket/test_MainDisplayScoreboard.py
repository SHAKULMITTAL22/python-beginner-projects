...
# Since the original module cannot be imported due to path or module name issues,
# we redefine the function as per the provided snippet for the sake of running tests.
