...
# Assuming the necessary functions are imported correctly from their respective modules
# Correcting the import statement based on the directory structure
from projects.HandCricket.main import play_game, display_scoreboard, user_turn
