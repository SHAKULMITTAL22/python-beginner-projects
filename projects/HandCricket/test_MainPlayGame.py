...
# Assuming the main code is included in the same script for testing purposes.
# Define the internal functions required by play_game
...
def user_turn(player_score, player_wickets, player_choice, over):
    ...
    while balls < 6 and player_wickets > 0:
        if player_choice == "1":
            ...
            opponent_choice = "1"  # Assume opponent always chooses to bat
            player_runs = random.randint(1, 6)
            opponent_runs = random.randint(1, 6)
        ...
        if player_choice == "1" and player_runs == opponent_runs:
            print("Player is out!")
            player_wickets -= 1
        elif player_choice == "2" and opponent_choice == "1" and player_runs == opponent_runs:
